                        ...
                        return new Promise(function (resolve) {
                            ...
                            S_user.login(scope.lo)
                                .then(function (u) {
                                    ...
                                    scope.loading = false;
                                    //The request will not cancel until the login is success
                                    //resolve(false);
                                    //keep login dialog
                                    return;
                                }, function (e) {
                                    $md.toastAlert(Atom.formatError(e));
                                    scope.loading = false;
                                    resolve(false);
                                    return true;
                                });
