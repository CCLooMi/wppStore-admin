...
(function(app) {
    ...
    app.state("main", {
        ...
        deps: [ "servs/taskServ.js", "ctrls/taskCtrl.js", "servs/apiServ.js", "ctrls/apiCtrl.js" ]
    }).state("main.localApis", {
        title: "LocalApis",
        url: "/localApis",
        templateUrl: "views/localApis.atom",
        deps: [ "servs/localApiServ.js", "ctrls/localApiCtrl.js" ]
    });
